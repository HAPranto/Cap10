...
def allVoice():
    ...
    elif "help" in query or "how to operate" in query:
...
#select,cut,copy,pest,undu,redu.------------------------------------
    ...
    elif "select this file" or "select this folder" or "select all" in query:
        time.sleep(3)
        pyautogui.click()
        speak("ok sir the file was selected")
    
    elif "select all file" or "select all folder" in query:
        time.sleep(3)
        pyautogui.hotkey('ctrl', 'a')
        speak("ok sir all file was selected")

    elif "copy this file" or "copy this folder" or "copy this line" in query:
        time.sleep(3)
        pyautogui.hotkey('ctrl', 'c')
        speak("Sir copy done.")
    
    elif "pest this file" or "pest this folder" or "pest this line" in query:
        time.sleep(3)
